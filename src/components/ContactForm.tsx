...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://formsubmit.co/ajax/iitwalabanda1234@gmail.com", {
        method: "POST",
        ...
        body: JSON.stringify({
          ...
          email,
          message,
          _subject: `New message from ${fullName} — Portfolio`,
          _captcha: "true",
          _template: "table",
        }),
      });
      ...
      toast({
        title: "Error",
        description: "Something went wrong! Try WhatsApp instead.",
        className: cn(
  ...
  return (
    <div className="w-full">
      <form className="w-full sm:mt-4" onSubmit={handleSubmit} aria-busy={loading}>
      ...
      <Link
        href="https://wa.me/919563316500?text=Hi%20Ayush!%20I%20found%20your%20portfolio%20and%20would%20like%20to%20connect."
        target="_blank"
      >
        <Button
          variant="outline"
