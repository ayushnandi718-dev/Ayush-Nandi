...
const SocketContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  const contextValue = React.useMemo(() => ({
    socket, users, setUsers, msgs, reactions, profileMap, cursorPositions, followingId, setFollowingId, hasMoreMessages, loadingHistory, fetchOlderMessages, initStatus, fetchInitialMessages
  }), [socket, users, msgs, reactions, profileMap, cursorPositions, followingId, hasMoreMessages, loadingHistory, initStatus]);
